...
class ViewController: UIViewController {
    ...
    private func fetchPtoducts() {
        do {
            let productsArrat = try NetworkLayer.shared.fetchproduct()
    ...
    private var products: [Product] = [
        ...
        .init(
            ...
            time: "20-25 minets",
            comment: "5.0(200)",
            typeOfBurger: "American : KFC",
            delivery: "Delivery: Free",
            price: "Minimum 8$",
            locationOfDelivery: "2.0 km away",
            image: "Basket"
        )
    ]
